...
<title>Personal Information - Emaar Properties Assets</title>
...
<div class="register-container">
    ...
    <div class="register-left">
        <div class="property-info">
            <div class="property-name">Welcome to Emaar Assets</div>
            <div class="property-details">Secure your investments with confidence</div>
        </div>
    </div>

    <div class="register-right">
        
        <form method="POST" action="{{ route('personal.info.store') }}" class="register-form">
            @csrf
    ...
    <select id="country" name="country" class="form-select" required>
        ...
        <option value="Other">Other</option>
            ...
            <div class="form-group">
                ...
                <input type="text" id="phone" name="phone" placeholder="e.g. +1 555 123 4567" value="{{ old('phone') }}" required>
            </div>

            <!-- Address -->
            <div class="form-group">
                <label for="address">Address</label>
                <input type="text" id="address" name="address" placeholder="Street, City, State" value="{{ old('address') }}" required>
            </div>
