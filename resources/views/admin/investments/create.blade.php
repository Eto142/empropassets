...
#previewImage { max-height: 160px; width: 100%; object-fit: cover; margin-top: 10px; border-radius: 8px; }
</style>
...
<div class="main-container">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <h2 class="fw-bold mb-0">Add Property Investment</h2>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror"
                               value="{{ old('type') }}" placeholder="e.g., Residential, Commercial">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="e.g., Sunset Villas">
                    ...
                    <div class="col-md-4" id="field_historic_yield">
                        ...
                        <input type="number" step="0.01" name="historic_yield"
                               ...
                               value="{{ old('historic_yield') }}" placeholder="e.g., 8.5">
                    ...
                    <div class="col-md-4" id="field_total_assets">
                        ...
                        <input type="number" name="total_assets"
                               ...
                               value="{{ old('total_assets') }}" placeholder="e.g., 5000000">
                    ...
                    <div class="col-md-4" id="field_sale_price">
                        ...
                        <input type="number" name="sale_price"
                               ...
                               value="{{ old('sale_price') }}" placeholder="e.g., 1250000">
                    ...
                    <div class="col-md-4" id="field_min_investment">
                        ...
                        <input type="number" name="min_investment"
                               ...
                               value="{{ old('min_investment') }}" placeholder="e.g., 10000">
                    ...
                    <div class="col-md-4" id="field_share_price">
                        ...
                        <input type="number" name="share_price"
                               ...
                               value="{{ old('share_price') }}" placeholder="e.g., 100">
                    ...
                    <div class="col-md-4" id="field_investors">
                        ...
                        <input type="number" name="investors"
                               ...
                               value="{{ old('investors') }}" placeholder="e.g., 120">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="location" class="form-control"
                               value="{{ old('location') }}" placeholder="e.g., Downtown, New York">
                    </div>

                    <div class="col-12">
                        <label class="form-label fw-semibold">Description</label>
                        <textarea name="description" rows="4" class="form-control"
                                  placeholder="Provide a brief description of the property">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <img id="previewImage" src="{{ asset('assets/images/placeholder.png') }}"
                             class="mt-2" style="height:120px; object-fit:cover; border-radius:8px; display:none;">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Gallery Images</label>
                        <input type="file" name="gallery[]" class="form-control" multiple accept="image/*">
                        <small class="text-muted">Select multiple files for the gallery.</small>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="size" class="form-control" value="{{ old('size') }}" placeholder="e.g., 2400">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Bedrooms</label>
                        <input type="number" name="bedrooms" class="form-control" value="{{ old('bedrooms') }}" placeholder="e.g., 4">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Bathrooms</label>
                        <input type="number" name="bathrooms" class="form-control" value="{{ old('bathrooms') }}" placeholder="e.g., 3">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Parking</label>
                        <input type="number" name="parking" class="form-control" value="{{ old('parking') }}" placeholder="e.g., 2">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Year Built</label>
                        <input type="number" name="year_built" class="form-control" value="{{ old('year_built') }}" placeholder="e.g., 2022">
                    </div>
